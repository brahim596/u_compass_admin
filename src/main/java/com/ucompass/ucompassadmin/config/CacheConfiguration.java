package com.ucompass.ucompassadmin.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.ucompass.ucompassadmin.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.ucompass.ucompassadmin.repository.UserRepository.USERS_BY_EMAIL_CACHE);
